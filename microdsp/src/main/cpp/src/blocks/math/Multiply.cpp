...
#undef LOG_TAG
#endif
#define LOG_TAG "Multiply"

constexpr size_t MAX_MATH_CHUNK = 4096;

Multiply::Multiply(DataType type, size_t num_inputs, const std::string& name)
...
template<typename T>
void Multiply::process(const std::vector<std::vector<T>>& in_bufs, T* out, size_t nitems) {
